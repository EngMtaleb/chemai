...
## Project 2 — Control Loop Performance *(in progress — week 4 of 7)*
...
├── features/        the form the physics requires · loop performance · data quality · shape · cascade
...
```bash
pip install -e ".[dev]"
pytest tests -q                              # 145 tests, no data needed
